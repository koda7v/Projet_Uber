...
public interface RestaurantRepository extends PagingAndSortingRepository<Restaurant, Long>
{
  ...
  @Modifying
  @Transactional
  @Query("DELETE FROM " + RestaurantConstantSQL.TABLE_NAME + "WHERE " + RestaurantConstantSQL.TABLE_NAME + "."
      + RestaurantConstantSQL.ID_COLUMN_NAME + " = :idResto ")
  void deleteRestaurant(@Param("idResto") Long idRest);
}
